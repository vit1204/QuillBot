  ...
  <div :class="$style.header">
    <ul>
      ...
      <li>
        <span>
          <svg
            class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-10dohqv" focusable="false"
      ...
      <li>
        <a href=""><img
          src="https://assets.quillbot.com/images/American.svg"
          style="width: 35px;height:32px;border-radius:50%;object-fit: cover;" alt=""
        ></a>
      </li>
      <li>
        <a href="">
          <img
            style="width: 32px;height:30px;border-radius:50%;object-fit: cover;"
