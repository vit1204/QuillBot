    ...
    <div :class="$style.Content">
      <div :class="$style.ContentParaPhrase">
        <div :class="$style.ContentLanguageList">
          <div v-for="(item, index) in languageList" v-show="index < 5" :key="index" :class="[
          ...
          <div :class="$style.TextArea">
            <div :class="$style.TextAreaLeftBox">
              ...
              <div :class="$style.TextAreaLeftFooter">
                ...
                <button disabled v-else :class="$style.TextAreaLeftButton" >
                  Loading...
                </button>
            ...
            <div :class="$style.TextAreaRightBox">
              <div r v-if="status === 'tooltip'" ref="tooltipRef" :style="{
                ...
                <img width="20" height="20" src="https://sgroupvn.org/_nuxt/img/logo-sgroup-symbol.ae66e60.png"
                  alt="" />
              </div>

              <div v-else-if="status === 'popover'" ref="popoverRef" :style="{
                  backgroundColor: 'white',
                  width: '480px',
                  height: '278px',
                  borderRadius: '12px',
                ...
                <div :class="$style.PopoverContainer">
                  <div :class="$style.PopoverHeader">
                    <div :class="$style.PopoverHeaderTitle">
                      ...
                      <el-icon :class="$style.Icon" @click="handleClosePopover" color="#A9A9A9">
                        <Close />
                      </el-icon>
                    </div>
                    ...
                    <div :class="$style.PopoverContent">
                      <div :class="$style.PopoverContentHeader">
                        ...
                        <div :class="$style.PopoverContentRefresh">
                          <el-icon @click="handlePreReplacetext" :class="$style.PopoverIcon" color="#DADCE0">
                            <ArrowLeft />
                          </el-icon>
                          ...
                          <el-icon @click="handleNextReplacetext" :class="$style.PopoverIcon" color="#DADCE0">
                            <ArrowRight />
                          </el-icon>
                        </div>
                      </div>
